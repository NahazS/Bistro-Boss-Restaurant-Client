...
const SoupSection = ({soups}) => {
    const section = {title: "SOUPS", description: "Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."}
    return (
        <div>
            ...
            <div className='mt-[79px] flex gap-[18px] flex-wrap justify-center max-w-[990px] px-5 xl:px-0 mx-auto'>
                {
                    soups.map(soup => <MenuCard menu={soup}></MenuCard>)
                }
            </div>
